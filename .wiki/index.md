...
| Installing or regenerating the `wiki-remember`/`wiki-create`/`wiki-update` Skills | [wiki-cli](wiki-cli.md) | `src/wiki_cli/skills.py`, `src/wiki_cli/skill_gen.py` | `install_skill`, `DEFAULT_SKILLS`, `render_skill_md`, `write_skill_files` | `tests/test_wiki_skills.py`, `tests/test_wiki_cli_install_skill.py`, `tests/test_wiki_skill_gen.py`, `tests/test_wiki_cli_generate_skills.py` | `pytest tests/test_wiki_skills.py tests/test_wiki_cli_install_skill.py tests/test_wiki_skill_gen.py tests/test_wiki_cli_generate_skills.py -v` |
...
| wiki-cli-performance | Delegate wiki create/update research to subagents to avoid token-burn from missing context compaction | active | 2026-09-02 | [decisions/wiki-cli-performance/2026-09-02-subagent-delegation-for-context-budget.md](decisions/wiki-cli-performance/2026-09-02-subagent-delegation-for-context-budget.md) |
| wiki-cli-prompt-design | Wiki pointer in AGENTS.md/CLAUDE.md now appends at end of file and opens with a brief description | active | 2026-09-02 | [decisions/wiki-cli-prompt-design/2026-09-02-wiki-pointer-appended-at-end-with-description.md](decisions/wiki-cli-prompt-design/2026-09-02-wiki-pointer-appended-at-end-with-description.md) |
